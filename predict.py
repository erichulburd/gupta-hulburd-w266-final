...
flags.DEFINE_string("model_dir", None,
                    "The model directory from where to load the trained model (Required for predictions).")
...
EVAL_FILE_NAME = make_filename('eval', (FLAGS.eval_percent), FLAGS.output_dir + '/features',
                               FLAGS.fine_tune, N_TRAIN_EXAMPLES)
TEST_FILE_NAME = make_filename('dev',1.0,FLAGS.output_dir + '/features',
                                FLAGS.fine_tune,None)
