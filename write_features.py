...
DATA_BERT_DIRECTORY = 'data/uncased_L-12_H-768_A-12'
...
flags.DEFINE_string("vocab_file", "%s/vocab.txt" % DATA_BERT_DIRECTORY,
                    "The vocabulary file that the BERT model was trained on.")

flags.DEFINE_string("output_dir", 'out/features/',
                    "The output directory where the model checkpoints will be written.")

DATA_SQUAD_DIRECTORY = 'data/squad'

flags.DEFINE_string("train_file", '%s/train-v2.0.json' % DATA_SQUAD_DIRECTORY,
                    "SQuAD json for training. E.g., train-v1.1.json")

flags.DEFINE_string("predict_file", '%s/dev-v2.0.json' % DATA_SQUAD_DIRECTORY,
                    "SQuAD json for predictions. E.g., dev-v1.1.json or test-v1.1.json")

flags.DEFINE_string("init_checkpoint", "%s/bert_model.ckpt" % DATA_BERT_DIRECTORY,
...
def main(_):
    ...
    _ = tf.contrib.tpu.RunConfig(cluster=tpu_cluster_resolver,
                                 master=FLAGS.master,
    ...
    write_features(FLAGS.train_file, os.path.join(FLAGS.output_dir, "train.tf_record"), True)
    write_features(FLAGS.predict_file, os.path.join(FLAGS.output_dir, "eval.tf_record"), False)


def write_features(input_file: str, output_file: str, is_training: bool):
